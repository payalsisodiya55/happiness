          ...
          <Card className="border-none shadow-lg overflow-hidden">
            <CardContent className="p-6 md:p-10 text-gray-700 leading-relaxed text-sm md:text-base space-y-8">
              ...
              <section>
                ...
                <p className="mb-4">
                   These Terms of Use ("Terms") govern the access or use by you, an individual, from within any country in the world of applications, websites, content, products, and services (the "Services") made available by Happiness Car Rental.
                </p>
                <div className="bg-orange-50 border-l-4 border-[#f48432] p-4 rounded-r-lg">
                  <p className="font-semibold text-[#29354c] mb-2">PLEASE READ THESE TERMS CAREFULLY BEFORE ACCESSING OR USING THE SERVICES.</p>
                  <p className="text-sm">
              ...
              <section>
                ...
                <p>
                  Happiness Car Rental may, at its sole discretion, create promotional codes that may be redeemed for Account credit. You agree that Promo Codes must be used for the intended audience and purpose, and in a lawful manner. Promo Codes may not be duplicated, sold, or transferred in any manner, or made available to the general public, unless expressly permitted. Promo Codes are not valid for cash and may expire prior to your use.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  You agree to not provide User Content that is defamatory, libelous, hateful, violent, obscene, pornographic, unlawful, or otherwise offensive.
                </p>
              </section>
